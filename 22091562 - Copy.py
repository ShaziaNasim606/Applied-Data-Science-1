...
def generate_correlation_heatmaps(dataframes_dict_transpose, countries):
    ...
    for country in countries:
        ...
        categories_name = ['urban population','rural population','inflation','GDP Growth','Fuel imports','Trade']
...
if __name__ == "__main__":
    ...
    create_line_plot(dataframes_dict_transpose["Fuel_imports"], title ="Fuel imports")
    create_line_plot(dataframes_dict_transpose["Trade"], title ="Trade")
